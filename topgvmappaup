...
image3 = simplegui.load_image('https://raw.githubusercontent.com/Edodo06/Phytontopg/main/pixil-frame-0%2520%25282%2529.png')
...
def draw(canvas):
    ...
    #layout
    canvas.draw_text(message,(700,30),20,"White")   
def timer_handler():       
    global time
    global position2
    global velx2
