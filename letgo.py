...
imagetopg = simplegui.load_image('https://raw.githubusercontent.com/Edodo06/Phytontopg/test/pixil-frame-0%2520%25283%2529.png')
...
def draw(canvas):
    ...
    canvas.draw_image(imagetopg, (400/2 , 400/2 ), (400,400), position, (radius*4, radius*4))
    if (scontro()):
        #esplosione da qui
...
def timer_handler():       
    ...
    if time%500 == 0:
        velx2 = velx2-random.randint(-2,3)
        print(velx2)
